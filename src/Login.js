            ...
            <div className='loginForm'>
                <Form>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        ...
                        <Form.Control type="text" placeholder="Логин" onChange={(evt) => setUserName(evt.target.value)} />
                    ...
                    <Form.Group className="mb-3" controlId="formBasicPassword">
                        ...
                        <Form.Control type="password" placeholder="Пароль" onChange={(evt) => setUserPassword(evt.target.value)} />
                    </Form.Group>
